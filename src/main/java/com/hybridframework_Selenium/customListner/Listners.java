...
public class Listners extends TestBase implements ITestListener {
	...
	public void onTestStart(ITestResult result) {
		...
		log("Automation test is Start, Test name is: "+result.getName());
	...
	public void onTestFailure(ITestResult result) {
		if(!result.isSuccess()){
			...
			try{
				String reportDirectory = new File(System.getProperty("user.dir")).getAbsolutePath()+"//src//main//java//com//hybridframework_Selenium//failureScreenshots//";
				File destFile = new File((String) reportDirectory +methodName +"-"+formater.format(calendar.getTime())+".png");
				FileUtils.copyFile(scrFile, destFile);
				Reporter.log("<a href='"+destFile.getAbsolutePath()+"'><img src='"+destFile.getAbsolutePath()+"'height ='100' widght ='100'/> </a>" );
			}
	...
	public void onTestSkipped(ITestResult result) {
		log("Automation test is skipped. This Test Name is "+result.getName());
